        ...
        <ScrollArea className="h-[calc(90vh-120px)]">
          <div className="bg-background p-8 space-y-8">
            ...
            <div className="border-b pb-8">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <h1 className="text-4xl font-normal mb-2">{service.name}</h1>
            ...
            {service.features && service.features.length > 0 && (
              <div>
                <h2 className="text-2xl font-normal mb-4">Features</h2>
            ...
            {service.typical_clients && service.typical_clients.length > 0 && (
              <div>
                <h2 className="text-2xl font-normal mb-4">Typical Clients</h2>
                <ul className="list-disc list-inside space-y-2">
            ...
            {service.benefits && (
              <div>
                <h2 className="text-2xl font-normal mb-4">Benefits</h2>
            ...
            {service.metodologia && (
              <div>
                <h2 className="text-2xl font-normal mb-4">Metodología</h2>
            ...
            {service.stats && service.stats.length > 0 && (
              <div>
                <h2 className="text-2xl font-normal mb-4">Statistics</h2>
