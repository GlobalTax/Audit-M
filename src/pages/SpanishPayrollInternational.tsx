...
export const SpanishPayrollInternational = () => {
  const painPoints = [
    {
      ...
      description: 'Complex EOR arrangements or compliance gaps'
    },
    {
      icon: Calculator,
      title: 'Managing tax withholdings remotely',
      description: 'IRPF calculations change based on personal circumstances'
    },
    {
      icon: FileText,
      title: 'Social Security compliance confusion',
      description: 'Multiple filing deadlines and contribution types'
    },
    {
      icon: Clock,
      title: 'Late filings and penalties',
      description: 'Missed deadlines result in automatic fines'
    },
  ];
  ...
  const processSteps = [
    {
      ...
      description: 'We handle Social Security registration and set up your payroll system.',
      duration: '1-2 weeks'
    },
    {
      step: 'Monthly',
      title: 'You Send Changes',
      description: 'You send hours, new hires, or salary changes. We process everything.',
      duration: 'By 25th of month'
    },
    {
      step: 'Reporting',
      title: 'We Deliver & File',
      description: 'Monthly summary to HQ, payslips to employees, filings to authorities.',
      duration: 'Automatic'
    },
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'We can advise on contractor arrangements and ensure proper classification. However, be aware that Spanish authorities scrutinize contractor relationships closely—misclassification can result in significant penalties. We recommend proper employment for ongoing roles.'
    },
    {
  ...
  return (
    <>
      <Meta
        title="Spanish Payroll for International Companies | NRRO"
        description="End-to-end payroll management for foreign companies with teams in Spain. Monthly filings, Social Security, tax withholdings—all handled by Barcelona-based experts."
        canonicalUrl="https://global.nrro.es/spanish-payroll-international"
      />
      <FAQSchema faqs={faqs} />
      ...
      <section className="bg-black text-white pt-40 pb-32 md:pt-48 md:pb-40" data-dark="true">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <BadgeHero className="mb-6">Spain Payroll Experts</BadgeHero>
            <h1 className="hero-title mb-6">
              Spanish Payroll Without the Hassle—For International Companies
            </h1>
            <p className="text-lead text-white/80 mb-8 max-w-2xl mx-auto">
              Monthly salaries, Social Security, tax withholdings, and compliance filings—managed by a Barcelona-based team.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-normal mb-4">
                Payroll in Spain Can Be Complex
              </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Complete payroll management so you can focus on your business.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Clear, predictable monthly fees based on team size.
              </p>
            </div>
      ...
      <section className="py-20 md:py-28 bg-black text-white" data-dark="true">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-normal mb-4">
                Ready to Simplify Your Spanish Payroll?
              </h2>
